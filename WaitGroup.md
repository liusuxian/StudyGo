...
![avatar](https://github.com/liusuxian/learning_golang/blob/master/img/WaitGroup1.jpg)
- 在32位环境下，如果state1不是64位对齐的地址，那么state1的第一个元素是信号量，后两个元素分别是waiter数和计数值。如图。
![avatar](https://github.com/liusuxian/learning_golang/blob/master/img/WaitGroup2.jpg)
### 使用WaitGroup时的常见错误。
...
### WaitGroup的知识地图。
![avatar](https://github.com/liusuxian/learning_golang/blob/master/img/WaitGroup3.jpg)
